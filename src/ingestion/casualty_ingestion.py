...
def ingest_casualty_data() -> None:
    ...
    try:
        ...
        print("Casualty ingestion completed successfully.")
        ...
        print(f"Casualty ingestion failed: {error}")

        raise


if __name__ == "__main__":
    ingest_casualty_data()